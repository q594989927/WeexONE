...
import com.paron.weextest.application.Constants;
import com.paron.weextest.component.ScreenUtil;
import com.paron.weextest.https.HotRefreshManager;
import com.paron.weextest.https.WXHttpManager;
import com.paron.weextest.https.WXHttpTask;
import com.paron.weextest.https.WXRequestListener;
        ...
        mContainer.post(new Runnable() {
            ...
            public void run() {
                ...
                mInstance.render(TAG, WXFileUtils.loadAsset(path, WXPageActivity.this),
                        mConfigMap, null,
                        ScreenUtil.getDisplayWidth(WXPageActivity.this), ScreenUtil.getDisplayHeight(WXPageActivity.this),

...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/c8e51cb86425a9b6a408a2d78d2b4477", [], function(__weex_require__, exports, __weex_module__){
	    ...
	    __weex_module__.exports = {
	        ...
	        methods: {
	            ...
	            getReadingIndex: function (index, loadmore) {
	                var self = this;
	                apis.getReadingIndex(stream,index, function (ret) {
	//                    modal.toast({'message': 'hide me!' + ret.data, 'duration': 1});
	            ...
	            getCarouselData: function () {
	                ...
	                apis.getReadingCarousel(stream,function (ret) {
	    ...
	    },
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.showSliderReplaceCell},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	          ...
	          "children": [
	            {
	              ...
	              "shown": function () {return this.readingList[this.$index].showType1},
	              "attr": {
	                "cid": function () {return this.content.content_id}
	              },
	              "events": {
	              ...
	              "children": [
	                {
	                  "type": "read-item",
	                  "attr": {
	                    "title": function () {return this.content.hp_title},
	                    "author": function () {return this.content.author[0].user_name},
	                    "content": function () {return this.content.guide_word}
	                  }
	                }
	              ]
	            },
	            {
	              ...
	              "shown": function () {return this.readingList[this.$index].showType2},
	              "attr": {
	                "cid": function () {return this.content.id}
	              },
	              "events": {
	              ...
	              "children": [
	                {
	                  "type": "read-item",
	                  "attr": {
	                    "title": function () {return this.content.title},
	                    "author": function () {return this.content.author.user_name},
	                    "content": function () {return this.content.excerpt}
	                  }
	                }
	              ]
	            },
	            {
	              ...
	              "shown": function () {return this.readingList[this.$index].showType3},
	              "attr": {
	                "cid": function () {return this.content.question_id}
	              },
	              "events": {
	              ...
	              "children": [
	                {
	                  "type": "read-item",
	                  "attr": {
	                    "title": function () {return this.content.question_title},
	                    "author": function () {return this.content.answer_title},
	                    "content": function () {return this.content.answer_content}
	                  }
	                }
	              ]
	            }
	...
	;__weex_bootstrap__("@weex-component/c8e51cb86425a9b6a408a2d78d2b4477", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/nav-bar-normal", [], function(__weex_require__, exports, __weex_module__){
...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/read-item", [], function(__weex_require__, exports, __weex_module__){
